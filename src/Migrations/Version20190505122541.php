 ...
 */
final class Version20190505122541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subscribed_category DROP matching, DROP categories');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subscribed_category ADD matching INT NOT NULL, ADD categories TEXT NOT NULL COLLATE latin1_swedish_ci');
