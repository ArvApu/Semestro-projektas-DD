 ...
 */
final class Version20190430154003 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD id INT AUTO_INCREMENT NOT NULL, ADD author_id INT NOT NULL, ADD category_id INT NOT NULL, ADD title VARCHAR(128) NOT NULL, ADD description LONGTEXT NOT NULL, ADD date DATETIME NOT NULL, ADD price NUMERIC(5, 2) DEFAULT NULL, ADD location VARCHAR(255) NOT NULL, DROP t0.id, DROP t0.title, DROP t0.description, DROP t0.date, DROP t0.price, DROP t0.location, DROP t0.author_id, DROP t0.category_id, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD t0.id INT NOT NULL, ADD t0.description TEXT NOT NULL COLLATE latin1_swedish_ci, ADD t0.date DATE NOT NULL, ADD t0.price INT NOT NULL, ADD t0.location TEXT NOT NULL COLLATE latin1_swedish_ci, ADD t0.author_id INT NOT NULL, ADD t0.category_id INT NOT NULL, DROP id, DROP author_id, DROP category_id, DROP title, DROP date, DROP price, DROP location, CHANGE description t0.title TEXT NOT NULL COLLATE latin1_swedish_ci');
    }
}
